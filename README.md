...
- 🔭 Currently working as an **AI Engineer** at **GlobalLogic (Hitachi Group)**, building RAG pipelines and enterprise LLM applications
- 🎓 B.Tech in Computer Science & Engineering (Data Science) from Shri Ramdeobaba College of Engineering and Management, Nagpur — CGPA 10
- 🧠 Focused on **RAG, LLM agents, LangChain/LangGraph, and vector search**
- 🔬 Former Research Intern at **IIT Bombay**, working on EDA and data visualization for academic datasets
- 💬 Ask me about Generative AI, RAG systems, LangChain, or Azure OpenAI
...
**GenAI Stack:** LangChain · LangGraph · AutoGen · Hugging Face · FAISS · Chroma · Azure OpenAI
